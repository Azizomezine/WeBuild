        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
				...
				<a href="index.php?page=home" class="nav-item nav-link"><span class='icon-field'><i class="fa fa-home"></i></span> Home</a>
                    ...
                    <a href="index.php?page=booked" class="nav-item nav-link"><i class="fa fa-th me-2"></i>booked flights</a>
                    ...
                    <a href="index.php?page=airlines" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Airlines</a>
                            ...
                            <a href="index.php?page=cars" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Cars</a>
                            <a href="index.php?page=reservation" class="nav-item nav-link"><i class="fa fa-table me-2"></i>booked Cars</a>
                            <!-- reservation-->
