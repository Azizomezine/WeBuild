...
<body>
    ...
    <section class="main-content920">
                 ...
                 <hr>
                    <form action="" method="POST">
                        <div class="question-title39">
                            <span class="form-description433">Category*</span><input type="text" id="ncateg"  name="ncateg" class="question-ttile32" value="<?php echo $Categorie['ncateg']; ?>" >
                        </div>
       ...
       <textarea type="text"  id="Article_editor" name="descateg"  ><?php echo $Categorie['descateg']; ?></textarea>
        </div>
                        </div>	
